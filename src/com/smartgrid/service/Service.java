...
public class Service {
	...
	// EDITAR DEVICE
	// http://localhost:8080/smartgrid/rest/updatedevice?id=16&name=smartplug&description=teste%20de%20&devicetype=SP
	@Path("/updatedevice")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public Response getDeviceList(
	...
	// DELETE DEVICE
	// http://localhost:8080/smartgrid/rest/deletedevice?id=5
	@Path("/deletedevice")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public Response getDeviceList(
		...
		return Response.ok("Device " + id + " apagado!").build(); // Responde 200 ok
	}		
